...
Here are some tips for starting the app:

- First clone the Git repository
- Install the requirments.txt (App folder)
- Add input folder from OneDrive App input repository (it includes models)
- The app should be ready to run
- Additionally, I have provided Dogs.zip file to test the app (OneDrive). It is recommended to also create your own photo collection (note that only JPG picutures should be included, and folder should not contain .DS_Store file or anything except images)
...
- First clone the Git repository
- Install the requirments.txt (App folder in the Git repository)
- Add input folder from OneDrive App input repository (it includes models)
- The app should be ready to run (main.py)
- Additionally, I have provided Dogs.zip file to test the app (OneDrive). It is recommended to also create your own photo collection (note that only JPG picutures should be included, and folder should not contain .DS_Store file or anything except images)
